...
(function () {
    ...
    settingPanel.innerHTML = ttPolicy.createHTML(`
        ...
        <label>API Key:<br />
          <input type="password" id="si-api-key" style="width:100%;" />
        </label><br />
        <label>Model:<br />
          <input type="text" id="si-model" style="width:100%;" />
        </label><br />
        <label>Endpoint:<br />
          <input type="text" id="si-endpoint" style="width:100%;" />
        </label><br />
        <label>System Prompt:<br />
          <textarea id="si-system-prompt" style="width:100%; height:60px;"></textarea>
        </label><br />
